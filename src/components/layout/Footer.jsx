        ...
        aashishnegi979@gmail.com
            ...
            <div className="text-center md:text-left">
              ...
              <div className="flex justify-center md:justify-start space-x-4">
                <a
                  href="https://www.facebook.com/TheSearchingSouls/"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://twitter.com/SearchingSouls_"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-[#2a4b38]/80 h-10 w-10 rounded-full flex items-center justify-center hover:bg-[#e1ed00] hover:text-[#1D3827] transition-colors duration-300 backdrop-blur-sm"
                  aria-label="Twitter"
                ...
                <a
                  href="https://www.instagram.com/thesearchingsouls/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-[#2a4b38]/80 h-10 w-10 rounded-full flex items-center justify-center hover:bg-[#e1ed00] hover:text-[#1D3827] transition-colors duration-300 backdrop-blur-sm"
                ...
                <a
                  href="https://www.youtube.com/channel/UCGi4eLxVqBoNPoeLdgR8dAA?view_as=subscriber"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-[#2a4b38]/80 h-10 w-10 rounded-full flex items-center justify-center hover:bg-[#e1ed00] hover:text-[#1D3827] transition-colors duration-300 backdrop-blur-sm"
                  aria-label="YouTube"
                ...
                <a
                  href="https://www.linkedin.com/company/searchingsouls/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-[#2a4b38]/80 h-10 w-10 rounded-full flex items-center justify-center hover:bg-[#e1ed00] hover:text-[#1D3827] transition-colors duration-300 backdrop-blur-sm"
                  aria-label="LinkedIn"
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-wrap justify-center md:justify-end">
            <ul className="flex flex-wrap justify-center gap-4 md:gap-6">
              ...
              <li>
                <a
                  href="https://www.thesearchingsouls.com/payment-policy/"
                  className="text-gray-200 hover:text-[#e1ed00] text-sm md:text-base transition-colors flex items-center"
                >
                  <svg
                    className="h-4 w-4 mr-1 text-[#e1ed00]"
